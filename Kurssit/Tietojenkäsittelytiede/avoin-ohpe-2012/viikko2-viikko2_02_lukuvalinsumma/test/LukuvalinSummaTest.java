...
@Points("2.2")
public class LukuvalinSummaTest {
    ...
    public void testi(int alaraja, int ylaraja, String[] oikeat) {
        io.setSysIn(alaraja + "\n" + ylaraja + "\n");
        LukuvalinSumma.main(new String[0]);
    ...
    @Test
    public void testi1() {
        testi(3, 7, new String[] {"anna alaraja anna yläraja 25"});
    }

    @Test
    public void testi2() {
        testi(3, 8, new String[] {"anna alaraja anna yläraja 33"});
    }
