...
public class ValikkoTest {
    ...
    @Test
    public void testi1() {
        testi("1, 2, 3", new String[] {"anna komento morjens", "anna komento hei vain", "anna komento"});
    }

    @Test
    public void testi2() {
        testi("2, 2, 1, 3", new String[] {"anna komento hei vain", "anna komento hei vain", "anna komento morjens", "anna komento"});
    }

    @Test
    public void testi3() {
        testi("3", new String[] {"anna komento"});
    }
