...
@Points("3.6")
public class NimetVaarinpainTest {
    ...
    public void testi(String syote, String[] oikeat) {
        ...
        NimetVaarinpain.main(new String[0]);
    ...
    @Test
    public void testi1() {
        testi("3, A, B, C", new String[] {"montako nimeä anna nimi anna nimi anna nimi nimet väärinpäin",
            "C", "B", "A"});
    }

    @Test
    public void testi2() {
        testi("5, A, B, C, D, E", new String[] {"montako nimeä anna nimi anna nimi anna nimi anna nimi anna nimi nimet väärinpäin",
            "E", "D", "C", "B", "A"});
    }

    @Test
    public void testi3() {
        testi("1, A", new String[] {"montako nimeä anna nimi nimet väärinpäin",
            "A"});
    }
